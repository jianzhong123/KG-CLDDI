...
args = parse_args()#parse.py

ROOT_PATH = "/home/zhongjian/KG-CLDDI-main/"
CODE_PATH = join(ROOT_PATH, 'check')
DATA_PATH = join(ROOT_PATH, 'data')#./data
