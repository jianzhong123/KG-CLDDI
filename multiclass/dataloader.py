...
def load_DDI_data_SPartition():
    # S1
    train_file = '../data/Drugbank/MUltiClass_TrainAll_S1.csv'
    test_file = '../data/Drugbank/MUltiClass_Test_S1.csv'

    # S2
    # train_file = os.path.join(data_dir, 'MUltiClass_TrainAll_S2.csv')
    # test_file = os.path.join(data_dir, 'MUltiClass_Test_S2.csv')
...
class UILoader(BasicDataset):
    def __init__(self, config=world.config, path="../data/Drugbank"):
        # train or test
        ...
        train_X, train_Y, test_X, test_Y = load_DDI_data("../data/Drugbank/multi_ddi_sift.txt")
        ...
        self.Item_labels = {}
        traindf = pandas.read_csv("../data/Drugbank/multi_ddi_sift.txt", delimiter='\t', header=None)
        self.Item_labels = {}
