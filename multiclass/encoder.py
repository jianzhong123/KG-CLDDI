...
class GCNEncoder(nn.Module):
    def __init__(self, num_features: int, features_nonzero: int,
        ...
        self.gc1 = GC(in_features=num_features, out_features=256, bias=bias)
        self.gc2 = GC(in_features=256, out_features=256, bias=bias)
...
class GCNEncoderWithFeatures(nn.Module):
    def __init__(self, num_features: int, features_nonzero: int,
        ...
        self.sparse = sparse
        GC = SparseGraphConvolution if sparse else GraphConvolution
        self.gc_input = GC(in_features=num_features, out_features=256, bias=bias)
        self.gc_hidden1 = GC(in_features=256, out_features=256, bias=bias)
        self.gc_hidden2 = GC(in_features=256, out_features=256, bias=bias)
        self.trans_h = nn.Linear(256 + num_features, 256, bias=True)
        self.trans_h1 = nn.Linear(256 + num_features, 256, bias=True)
        self.trans_h2 = nn.Linear(256 + num_features, 256, bias=True)
